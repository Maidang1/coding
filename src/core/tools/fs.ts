...
export class FsReadTool extends Tool {
  ...
  override execute(input: { path: string }): ToolExecutionResult {
...
export class FsWriteTool extends Tool {
  ...
  override execute(input: { path: string; content: string }): ToolExecutionResult {
    const filePath = safeResolve(this.params.projectRoot, input.path);
...
export class FsPatchTool extends Tool {
  ...
  override execute(input: { patch: string }): ToolExecutionResult {
